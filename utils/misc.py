...
import numpy as np
from models import MDRNNCellAttn, VAE, Controller
import gym
...
class RolloutGenerator(object):
    ...
    def __init__(self, mdir, device, time_limit):
        ...
        vae_file, rnn_file, ctrl_file = \
            [join(mdir, m, 'best.tar') for m in ['vae', 'mdrnn', 'ctrl_attn']]
        ...
        self.mdrnn = MDRNNCellAttn(LSIZE, ASIZE, RSIZE, 5).to(device)
